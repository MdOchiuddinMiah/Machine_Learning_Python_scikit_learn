...
eeg_data=pd.read_csv("E:\\Research\\Ensemble DT in BMI\\2_3_class_data\\3omitrain.csv")
eeg_test_data=pd.read_csv("E:\\Research\\Ensemble DT in BMI\\2_3_class_data\\3omitest.csv")
