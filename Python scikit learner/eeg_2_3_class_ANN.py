...
eeg_data=pd.read_csv("D:\Research\Ensemble DT in BMI\\2_3_class_data\\2omitrain.csv")
eeg_test_data=pd.read_csv("D:\Research\Ensemble DT in BMI\\2_3_class_data\\2omitest.csv")
eeg_data.head()
